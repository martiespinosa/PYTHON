...
ventana.iconbitmap("contraseña.ico")
...
botMin = Button(ventana, text = "minúscula", width=9, height=2, border="0", bg="grey20", fg="grey75", font = ("MS Reference Sans Serif", 6, "bold"))
botMin.place(x = 20, y = 170)
botMay = Button(ventana, text = "mayúscula", width=9, height=2, border="0", bg="gray20", fg="grey75", font = ("MS Reference Sans Serif", 6, "bold"))
botMay.place(x = 90, y = 170)
botNum = Button(ventana, text = "número", width=7, height=2, border="0", bg="gray20", fg="grey75", font = ("MS Reference Sans Serif", 6, "bold"))
botNum.place(x = 160, y = 170)
botCE = Button(ventana, text = "caracter especial", width=15, height=2, border="0", bg="gray20", fg="grey75", font = ("MS Reference Sans Serif", 6, "bold"))
