            ...
            if paraulaUsuari == todasLasPalabrasDeUnaEnUna:
                ...
                for w in range(5):
                    ...
                    if paraulaUsuari == palabraElejida:
                        ...
                        miCursor = miConexion.cursor()
                        miCursor.execute("INSERT INTO ESTADISTICAS, WINS VALUES(+1)")        
                        miConexion.commit()
                        miConexion.close()
...
def update_ui(root):
    ...
    if check_fullscreen(root):
        ...
        entry_f1_c1.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f1_c1.place(relx=0.38, rely=0.23, anchor = CENTER)
        # def set_focus():
        #     entry_f1_c1.focus()
        # app.after(300, set_focus)

        entry_f1_c2.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f1_c2.place(relx=0.44, rely=0.23, anchor = CENTER)

        entry_f1_c3.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f1_c3.place(relx=0.5, rely=0.23, anchor = CENTER)

        entry_f1_c4.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f1_c4.place(relx=0.56, rely=0.23, anchor = CENTER)

        entry_f1_c5.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f1_c5.place(relx=0.62, rely=0.23, anchor = CENTER)


        entry_f2_c1.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f2_c1.place(relx=0.38, rely=0.34, anchor = CENTER)

        entry_f2_c2.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f2_c2.place(relx=0.44, rely=0.34, anchor = CENTER)

        entry_f2_c3.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f2_c3.place(relx=0.5, rely=0.34, anchor = CENTER)

        entry_f2_c4.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f2_c4.place(relx=0.56, rely=0.34, anchor = CENTER)

        entry_f2_c5.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f2_c5.place(relx=0.62, rely=0.34, anchor = CENTER)


        entry_f3_c1.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f3_c1.place(relx=0.38, rely=0.45, anchor = CENTER)

        entry_f3_c2.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f3_c2.place(relx=0.44, rely=0.45, anchor = CENTER)

        entry_f3_c3.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f3_c3.place(relx=0.5, rely=0.45, anchor = CENTER)

        entry_f3_c4.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f3_c4.place(relx=0.56, rely=0.45, anchor = CENTER)

        entry_f3_c5.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f3_c5.place(relx=0.62, rely=0.45, anchor = CENTER)


        entry_f4_c1.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f4_c1.place(relx=0.38, rely=0.56, anchor = CENTER)

        entry_f4_c2.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f4_c2.place(relx=0.44, rely=0.56, anchor = CENTER)

        entry_f4_c3.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f4_c3.place(relx=0.5, rely=0.56, anchor = CENTER)

        entry_f4_c4.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f4_c4.place(relx=0.56, rely=0.56, anchor = CENTER)

        entry_f4_c5.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f4_c5.place(relx=0.62, rely=0.56, anchor = CENTER)


        entry_f5_c1.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f5_c1.place(relx=0.38, rely=0.67, anchor = CENTER)

        entry_f5_c2.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f5_c2.place(relx=0.44, rely=0.67, anchor = CENTER)

        entry_f5_c3.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f5_c3.place(relx=0.5, rely=0.67, anchor = CENTER)

        entry_f5_c4.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f5_c4.place(relx=0.56, rely=0.67, anchor = CENTER)

        entry_f5_c5.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f5_c5.place(relx=0.62, rely=0.67, anchor = CENTER)


        entry_f6_c1.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f6_c1.place(relx=0.38, rely=0.78, anchor = CENTER)

        entry_f6_c2.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f6_c2.place(relx=0.44, rely=0.78, anchor = CENTER)

        entry_f6_c3.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f6_c3.place(relx=0.5, rely=0.78, anchor = CENTER)

        entry_f6_c4.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        entry_f6_c4.place(relx=0.56, rely=0.78, anchor = CENTER)

        entry_f6_c5.configure(width=60, height=60, font=("Dubai", 30, "bold"))
        ...
        entry_f1_c1.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f1_c1.place(relx=0.2, rely=0.25, anchor = CENTER)
        # def set_focus():
        #     entry_f1_c1.focus()
        # app.after(300, set_focus)

        entry_f1_c2.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f1_c2.place(relx=0.35, rely=0.25, anchor = CENTER)

        entry_f1_c3.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f1_c3.place(relx=0.5, rely=0.25, anchor = CENTER)

        entry_f1_c4.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f1_c4.place(relx=0.65, rely=0.25, anchor = CENTER)

        entry_f1_c5.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f1_c5.place(relx=0.8, rely=0.25, anchor = CENTER)


        entry_f2_c1.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f2_c1.place(relx=0.2, rely=0.35, anchor = CENTER)

        entry_f2_c2.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f2_c2.place(relx=0.35, rely=0.35, anchor = CENTER)

        entry_f2_c3.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f2_c3.place(relx=0.5, rely=0.35, anchor = CENTER)

        entry_f2_c4.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f2_c4.place(relx=0.65, rely=0.35, anchor = CENTER)

        entry_f2_c5.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f2_c5.place(relx=0.8, rely=0.35, anchor = CENTER)


        entry_f3_c1.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f3_c1.place(relx=0.2, rely=0.45, anchor = CENTER)

        entry_f3_c2.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f3_c2.place(relx=0.35, rely=0.45, anchor = CENTER)

        entry_f3_c3.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f3_c3.place(relx=0.5, rely=0.45, anchor = CENTER)

        entry_f3_c4.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f3_c4.place(relx=0.65, rely=0.45, anchor = CENTER)

        entry_f3_c5.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f3_c5.place(relx=0.8, rely=0.45, anchor = CENTER)


        entry_f4_c1.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f4_c1.place(relx=0.2, rely=0.55, anchor = CENTER)

        entry_f4_c2.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f4_c2.place(relx=0.35, rely=0.55, anchor = CENTER)

        entry_f4_c3.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f4_c3.place(relx=0.5, rely=0.55, anchor = CENTER)

        entry_f4_c4.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f4_c4.place(relx=0.65, rely=0.55, anchor = CENTER)

        entry_f4_c5.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f4_c5.place(relx=0.8, rely=0.55, anchor = CENTER)


        entry_f5_c1.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f5_c1.place(relx=0.2, rely=0.65, anchor = CENTER)

        entry_f5_c2.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f5_c2.place(relx=0.35, rely=0.65, anchor = CENTER)

        entry_f5_c3.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f5_c3.place(relx=0.5, rely=0.65, anchor = CENTER)

        entry_f5_c4.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f5_c4.place(relx=0.65, rely=0.65, anchor = CENTER)

        entry_f5_c5.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f5_c5.place(relx=0.8, rely=0.65, anchor = CENTER)


        entry_f6_c1.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f6_c1.place(relx=0.2, rely=0.75, anchor = CENTER)

        entry_f6_c2.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f6_c2.place(relx=0.35, rely=0.75, anchor = CENTER)

        entry_f6_c3.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f6_c3.place(relx=0.5, rely=0.75, anchor = CENTER)

        entry_f6_c4.configure(width=40, height=40, font=("Dubai", 20, "bold"))
        entry_f6_c4.place(relx=0.65, rely=0.75, anchor = CENTER)

        entry_f6_c5.configure(width=40, height=40, font=("Dubai", 20, "bold"))
...
def elegir_palabra_aleatoria():
    ...
    global palabraElejida
    palabraElejida = miCursor.fetchone()[0]
...
miConexion = connect(r"C:\Users\MARTI\Desktop\PYTHON\BBDD\PALABRAS_WORDLE_1K")
miCursor = miConexion.cursor()
miCursor.execute("SELECT FECHA FROM FECHAS WHERE ID = 1")
ultima_fecha = miCursor.fetchone()[0]

print(ultima_fecha)

if str(fecha_actual) != str(ultima_fecha):
    elegir_palabra_aleatoria()
    miCursor.execute("UPDATE FECHAS SET FECHA = ? WHERE ID = ?", (fecha_actual,1))
    miCursor.execute("UPDATE FECHAS SET PALABRA = ? WHERE ID = ?", (palabraElejida,1))
    miConexion.commit()
    miConexion.close()
    ultima_fecha = fecha_actual
else:
    miCursor.execute("SELECT PALABRA FROM FECHAS WHERE ID = 1")
    palabraElejida = miCursor.fetchone()[0]
    miConexion.commit()
    miConexion.close()
    print(palabraElejida)
...
labelWordle = CTkLabel(master=app, text="WORDLE", justify=CENTER, padx=110, pady=40)
# labelWordle.place(relx=0.5, rely=0.1, anchor = CENTER)

# ------------ fila 1 ------------

entry_f1_c1 = CTkEntry(master=app, justify=CENTER, validate="key", validatecommand=(app.register(lambda event: validar_y_mover(event, entry_f1_c1, entry_f1_c2)), "%S"), insertontime=0, textvariable=var_f1_c1, takefocus=False)
# entry_f1_c1.place(relx=0.2, rely=0.25, anchor = CENTER)
# def set_focus():
#     entry_f1_c1.focus()
# app.after(300, set_focus)
...
entry_f3_c4 = CTkEntry(master=app, width=40, height=40, font=("Dubai", 20, "bold"), justify=CENTER, validate="key", validatecommand=(app.register(lambda event: validar_y_mover(event, entry_f3_c5, entry_f3_c5)), "%S"), insertontime=0, textvariable=var_f3_c4, takefocus=False)
# entry_f3_c4.place(relx=0.65, rely=0.45, anchor = CENTER)
