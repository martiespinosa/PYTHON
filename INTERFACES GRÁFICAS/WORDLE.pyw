    ...
    if entry_actual == labelWordle and event.keysym == "Return":
        ...
        if entry_f1_c5.get() != "" and entry_f2_c5.get() == "" and entry_f3_c5.get() == "" and entry_f4_c5.get() == "" and entry_f5_c5.get() == "" and entry_f6_c5.get() == "":
            ...
            for w in range(5):
                if paraulaUsuari[w] == palabraElejida[w]:
                    listaEntrys[w].configure(fg_color="green")
            ...
            for w in range(5):
                if paraulaUsuari[w] != palabraElejida[w] and (paraulaUsuari[w] == palabraElejida[0] or paraulaUsuari[w] == palabraElejida[1] or paraulaUsuari[w] == palabraElejida[2] or paraulaUsuari[w] == palabraElejida[3] or paraulaUsuari[w] == palabraElejida[4]):
                    if paraulaUsuari[w] == "A":
                        if AA > 0:
                            listaEntrys[w].configure(fg_color="yellow")
                            AA -= 1
        ...
        # FILA 2
            ...
            for w in range(5):
                if paraulaUsuari[w] == palabraElejida[w]:
                    listaEntrys[w].configure(fg_color="green")
                    if palabraElejida[w] == "A":
                        AA -= 1
                    if palabraElejida[w] == "B":
                        BB -= 1
                    if palabraElejida[w] == "C":
                        CC -= 1
                    if palabraElejida[w] == "D":
                        DD -= 1
                    if palabraElejida[w] == "E":
                        EE -= 1
                    if palabraElejida[w] == "F":
                        FF -= 1
                    if palabraElejida[w] == "G":
                        GG -= 1
                    if palabraElejida[w] == "H":
                        HH -= 1
                    if palabraElejida[w] == "I":
                        II -= 1
                    if palabraElejida[w] == "J":
                        JJ -= 1
                    if palabraElejida[w] == "K":
                        KK -= 1
                    if palabraElejida[w] == "L":
                        LL -= 1
                    if palabraElejida[w] == "M":
                        MM -= 1
                    if palabraElejida[w] == "N":
                        NN -= 1
                    if palabraElejida[w] == "Ñ":
                        ÑÑ -= 1
                    if palabraElejida[w] == "O":
                        OO -= 1
                    if palabraElejida[w] == "P":
                        PP -= 1
                    if palabraElejida[w] == "Q":
                        QQ -= 1
                    if palabraElejida[w] == "R":
                        RR -= 1
                    if palabraElejida[w] == "S":
                        SS -= 1
                    if palabraElejida[w] == "T":
                        TT -= 1
                    if palabraElejida[w] == "U":
                        UU -= 1
                    if palabraElejida[w] == "V":
                        VV -= 1
                    if palabraElejida[w] == "W":
                        WW -= 1
                    if palabraElejida[w] == "X":
                        XX -= 1
                    if palabraElejida[w] == "Y":
                        YY -= 1
                    if palabraElejida[w] == "Z":
                        ZZ -= 1
...
numPalabraElejida = random.choice(range(4))+1
