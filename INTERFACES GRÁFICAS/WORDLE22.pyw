            ...
            if paraulaUsuari == todasLasPalabrasDeUnaEnUna:
                ...
                if paraulaUsuari != palabraElejida:
                    if entry_f1_c5.get() != "" and entry_f2_c5.get() == "" and entry_f3_c5.get() == "" and entry_f4_c5.get() == "" and entry_f5_c5.get() == "" and entry_f6_c5.get() == "":
                        ...
                        labelLaPalabraEra = CTkLabel(master=app, text="No has acertado la palabra de hoy, la palabra era:", font=("Dubai", 12, "bold"), justify=CENTER, padx=110)
                        labelLaPalabraEra.place(relx=0.5, rely=0.83, anchor = CENTER)
                        labelRespuesta = CTkLabel(master=app, text=f"{palabraElejida}", font=("Dubai", 33, "bold"), justify=CENTER, padx=110)
                        labelRespuesta.place(relx=0.5, rely=0.9, anchor = CENTER)
                else:
...
fotoEspanol = CTkImage(light_image=Image.open(r"C:\Users\MARTI\Desktop\PYTHON\INTERFACES GRÁFICAS\espanol.png"), dark_image=Image.open(r"C:\Users\MARTI\Desktop\PYTHON\INTERFACES GRÁFICAS\espanol.png"), size=(40,40))
botonEspanol = CTkButton(master=app, width=40, height=40, text="", image=fotoEspanol, fg_color="transparent", hover = False, cursor = "hand2")
botonEspanol.place(relx=0.2, rely=0.1, anchor=CENTER)

fotoEnglish = CTkImage(light_image=Image.open(r"C:\Users\MARTI\Desktop\PYTHON\INTERFACES GRÁFICAS\englis.png"), dark_image=Image.open(r"C:\Users\MARTI\Desktop\PYTHON\INTERFACES GRÁFICAS\englis.png"), size=(40,40))
botonEnglish = CTkButton(master=app, width=40, height=40, text="", image=fotoEnglish, fg_color="transparent", hover = False, cursor = "hand2")
botonEnglish.place(relx=0.8, rely=0.1, anchor=CENTER)
